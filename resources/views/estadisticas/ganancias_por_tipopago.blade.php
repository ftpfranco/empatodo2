                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-xl-10 ">
                        <div class="card shadow">
                            ...
                            <div class="card-body ">
                                <div class="card-title my-0 py-0"> Ganancias por métodos de pago </div>
    ...
    <script>
        $(document).ready(async function() {
            ...
            async function getAjax(url = null) {
                if (url == null) {
                    url = window.location.origin + "/estadisticas/ganancias_por_tipopago"
                }
            ...
            function charjss(data) {
                var barOptions = {
                    series: [{
                        ...
                        // },
                        {
                            name: "Efectivo Pedidos Ya",
                            data: data.efectivo_pedidosya,
                        },
                        {
                            name: "Credito Pedidos Ya",
                            data: data.credito_pedidosya,
                        },
                    ],
                    chart: {
                        type: "bar",
                    ...
                    stroke: {
                        ...
                        width: 2,
                        // colors: ["transparent"],
                        // colors: ['#f1a82c', '#0bd018', '#0933daa3', ' #7637eaa3' ]
                    },
                    ...
                    fill: {
                        ...
                        // colors: ['#f2e82c','#f1f1f1', '#0bd018', '#0933daa3', ' #7637eaa3' ]
                    },
                    tooltip: {
                        y: {
            ...
            $(document).on("click", ".filtro-dia", function() {
                var url = window.location.origin + "/estadisticas/ganancias_por_tipopago?filtro=dia"
                $("#bar").empty()
                destroyChart()
                getAjax(url)
            })
            ...
            $(document).on("click", ".filtro-semana", function() {
                var url = window.location.origin + "/estadisticas/ganancias_por_tipopago?filtro=semana"
                $("#bar").empty()
                destroyChart()
                getAjax(url)
            })
            ...
            $(document).on("click", ".filtro-mes", function() {
                var url = window.location.origin + "/estadisticas/ganancias_por_tipopago?filtro=mes"
                $("#bar").empty()
                destroyChart()
                getAjax(url)
            })
            ...
            $(document).on("click", ".filtro-anio", function() {
                var url = window.location.origin + "/estadisticas/ganancias_por_tipopago?filtro=anio"
                $("#bar").empty()
                destroyChart()
                getAjax(url)
            })
