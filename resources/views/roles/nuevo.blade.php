...
@section('content')
    ...
    <div class="page-heading mx-3 mb-1">
        <div class="mb-3 mt-0">
            ...
            @endcan
            @can("agregar.roles")
            <a class="btn btn-success mt-1 " href="{{ url('roles/nuevo') }}">Nuevo rol</a>
            @endcan
        </div>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control nombre-rol"  >
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                @if (isset($permisos_categorias) && count($permisos_categorias))
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <h5>Categorias</h5>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            @foreach ($permisos_categorias as $item)
...
@section('scripts')
    ...
    <script defer src="{{ asset('js/resources/roles.nuevo.js') }}"></script>
    {{-- <script defer src="{{ asset('js/roles.nuevo.min.js') }}"></script> --}}
