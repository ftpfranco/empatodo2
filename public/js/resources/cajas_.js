        ...
        try {
            await $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.data) {
                            var diferencia = `<span class="badge bg-success"> ${
              response.data.diferencia ? response.data.diferencia : ''
            }  </span>`
                            if (response.data.diferencia < 0) {
                                diferencia = `<span class="badge bg-danger"> ${
                response.data.diferencia ? response.data.diferencia : ''
              }  </span>`
                            }
                            var tr = `
                            <tr>
                                <td hidden class="caja_id"> ${
